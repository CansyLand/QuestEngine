 ...
 *
 * This script converts JSON data files in data/ to TypeScript constants
 ...
 *   or
 *   npx tsx core/services/data/DataCompiler.ts
 *
...
function generateDataFile() {
	...
	let output = `// data.ts - Embedded game data for QuestEngine
// This file contains all the game configuration data embedded as constants
// Auto-generated from project data/*.json files - DO NOT EDIT MANUALLY
...
// This file was migrated from questEditor/core/generate-data.ts
...
// Originally from questEditor/core/generate-data.ts, migrated to new structure
