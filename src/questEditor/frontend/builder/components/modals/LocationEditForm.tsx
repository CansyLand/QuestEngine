...
import { Location, NPC, Portal, Item } from '../../../../models'
import { ArrayField } from '../ui/ArrayField'
import { ItemDisplay, NPCDisplay, PortalDisplay } from '../ui/EntityDisplay'
import { EntityTooltip, TooltipEntity } from '../ui/EntityTooltip'
  ...
  return (
    <div className="edit-form">
      <div className="form-group">
        <label>Name:</label>
        <input type="text" value={location.name} onChange={(e) => onUpdate({ name: e.target.value })} />
      </div>
      <div className="form-group">
      ...
      <div className="form-group">
        <label>Image:</label>
        <ImagePicker value={location.image} onChange={(value) => onUpdate({ image: value })} />
      </div>
      <div className="form-group">
        <label>Items:</label>
        <ArrayField
