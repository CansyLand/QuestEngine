        ...
        <div className="dialogue-content">
          {dialogueSequence.npcImage && (
            <div className="dialogue-portrait">
              <img src={dialogueSequence.npcImage} alt="NPC Portrait" className="npc-portrait-image" />
            </div>
          )}
          ...
          {currentDialog.buttons && currentDialog.buttons.length > 0 ? (
            <div className="dialogue-buttons">
              {currentDialog.buttons.map((button, index) => (
                <button key={index} className="dialogue-button" onClick={() => handleButtonClick(button.goToDialog)}>
                  {button.label}
                </button>
              ))}
            </div>
            ...
            <div className="dialogue-buttons">
              <button className="dialogue-button next-button" onClick={handleNext}>
                Next
              </button>
            </div>
          )}
