...
export class GameEngine {
  ...
  private removeFromInventoryByName(itemName: string, count: number): Command[] {
  ...
  private setInteractive(entityId: string, interactiveMode: InteractiveMode): Command[] {
  ...
  private setInteractiveByName(itemName: string, interactiveMode: InteractiveMode): Command[] {
