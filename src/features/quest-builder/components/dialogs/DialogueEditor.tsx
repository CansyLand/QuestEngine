...
import { DialogueSequence, Dialog, Button } from '@/core/models/types'
import { DialogueEditorState } from '@/features/quest-builder/types'
								...
								<div key={dialog.id} className='dialog-item'>
									<div className='dialog-header'>
										...
										<button
											...
											onClick={() => onRemoveDialog(dialogIndex)}
										>
											Remove
										</button>
									</div>
									<div className='dialog-fields'>
										<div className='field-group'>
											...
											<textarea
												value={dialog.text}
												onChange={(e) =>
													onUpdateDialog(dialogIndex, { text: e.target.value })
												}
												rows={3}
											/>
										</div>
											...
											<div className='field-group'>
												...
												<div className='buttons-list'>
														...
														<div key={buttonIndex} className='button-item'>
															<div className='button-fields'>
																<input
																	...
																	value={button.label}
																	onChange={(e) =>
																		onUpdateButton(dialogIndex, buttonIndex, {
																...
																>
																	{dialogueEditor.sequence?.dialogs.map(
																		(d, i) => (
															...
															<button
																...
																className='remove-button small'
																onClick={() =>
																	onRemoveButton(dialogIndex, buttonIndex)
																}
															>
																Remove
															</button>
													...
													<button
														...
														onClick={() => onAddButton(dialogIndex)}
													>
														Add Button
													</button>
												</div>
