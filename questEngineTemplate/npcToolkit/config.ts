...
export let extraskin: any[] = [
  Color4.create(0.24, 0.13, 0.04),
  Color4.create(0.6, 0.37, 0.22),
  Color4.create(0.48, 0.28, 0.09),
  Color4.create(0.98, 0.82, 0.51)
]

export let extrahair: any[] = [
  Color4.create(0.6, 0.37, 0.22),
  Color4.create(0.3, 0.52, 0.4),
  Color4.create(0.55, 0.13, 0.08),
  Color4.create(0.11, 0.11, 0.11),
  Color4.create(0.48, 0.28, 0.09),
  Color4.create(0.98, 0.82, 0.51),
  Color4.create(0.55, 0.13, 0.08)
]
